...
* [Database](#database)
  ...
  * [Aurora DB](#aurora-db)
    ...
    * [1. ✅ **Aurora Standby Equivalent (High Availability)**](#1--aurora-standby-equivalent-high-availability)
    * [2. ✅ **Aurora Read Replicas (Scaling)**](#2--aurora-read-replicas-scaling)
    * [🤖 Failover Logic in Aurora](#-failover-logic-in-aurora)
    * [**Summary: Aurora vs RDS**](#summary-aurora-vs-rds)
